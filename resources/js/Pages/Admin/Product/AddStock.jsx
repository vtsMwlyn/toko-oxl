...
export default function AddStock({ isOpen, onClose, variant, product, isHeadCashier = false }) {
    ...
    const submit = (e) => {
        ...
        post(route(
            isHeadCashier ? 'head-cashier.product.variant.add-stock' : 'admin.product.variant.add-stock',
            { variant: variant.id }
        ), {
            onSuccess: () => {
                setSuccess(true);
