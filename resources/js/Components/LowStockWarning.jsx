...
export default function LowStockWarning({ variants, threshold }) {
    if (!threshold || variants.length === 0) return null;
        ...
        <div className="rounded-2xl border border-amber-200 bg-amber-50 p-4">
            <div className="flex items-center gap-2 mb-3">
                ...
                <p className="text-sm font-semibold text-amber-700">
                    {variants.length} varian memiliki stok rendah (≤ {threshold})
                </p>
            </div>
